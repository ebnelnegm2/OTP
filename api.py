...
private_group_id = -4698009361

approved_group_id = -2353465460


mainc = "https://t.me/ebnelnegmbot"  # تأكد من أن الرابط صحيح
...
def send_subscription_message(message):
    ...
    contact_button = types.InlineKeyboardButton(text="♤ Programmer", url="https://t.me/ebn_elnegm_shop")
    keyboard.add(contact_button)
    bot.send_message(chat_id=message.chat.id, text=f'''<b>♤ Welcome Dear -> {message.from_user.first_name} ♤
♤ Youre Not Subscribed in Check EBNELNEGM Bot ❌
♤ Channel ~ @ebn_elnegm_shop
♤ For Show Bot Prices Send -> /buy
♤ Programmers ~ @ebn_elnegm </b>''', reply_markup=keyboard)
...
def dato(zh):
    try:
        ...
        mn = f'''[<a href="https://t.me/ebnelnegmbot">ϟ</a>] 𝗜𝗻𝗳𝗼 -> {brand} - {card_type} - {card_level}
[<a href="https://t.me/ebnelnegmbot">ϟ</a>] 𝗕𝗮𝗻𝗸 : {bank} - {country_flag}
[<a href="https://t.me/ebnelnegmbot">ϟ</a>] 𝗖𝗼𝘂𝗻𝘁𝗿𝘆 : {country_name} [ {country_flag} ]'''
        return mn
...
- Gate -> {gate} 💫
- Programmer -> @ebn_elnegm </b>''',
                                          reply_markup=mes)

                    # تنسيق الرسالة لتكون مشابهة للبطاقة المطلوبة
                    result_msg = f'''#3DS_Lookup_Paypal_1  🌩
━━━━━━━━━━━━━
[<a href="https://t.me/ebnelnegmbot">ϟ</a>] Cc: <code>{cc}</code>
[<a href="https://t.me/ebnelnegmbot">ϟ</a>] Status: {"Approved! ✅" if "Successful" in last else "Rejected ❌"}
[<a href="https://t.me/ebnelnegmbot">ϟ</a>] Response: {last}

{str(dato(cc[:6]))}

[<a href="https://t.me/ebnelnegmbot">ϟ</a>] T/t: {"{:.2f}".format(execution_time)}(s) | [Px: {"Live! ✅" if "Successful" in last else "Live! ✅"}] 
[<a href="https://t.me/ebnelnegmbot">ϟ</a>] Req: @{user_username} | [VIP]
━━━━━━━━━━━━━
Dev by : <code>@ebn_elnegm</code> 🌤'''
...
━━━━━━━━━━━━━
[<a href="https://t.me/ebnelnegmbot">ϟ</a>] Cc: <code>{cc}</code>
[<a href="https://t.me/ebnelnegmbot">ϟ</a>] Status: {"Approved! ✅" if "3DS Challenge Required" in last else "Rejected ❌"}
[<a href="https://t.me/ebnelnegmbot">ϟ</a>] Response: {last}
...
[<a href="https://t.me/ebnelnegmbot">ϟ</a>] T/t: {"{:.2f}".format(execution_time)}(s) | [Px: {"Live! ✅" if "3DS Challenge Required" in last else "Live! ✅"}] 
[<a href="https://t.me/ebnelnegmbot">ϟ</a>] Req: @{user_username} | [VIP]
━━━━━━━━━━━━━
Dev by : <code>@ebn_elnegm</code> 🌤'''
...
You are Not Subscribed EBNELNEGM CHK !❌
...
def generate_code(message):
    def my_function():
        ...
        try:
            ...
            pas = 'EBNELNEGM-' + '2025' +'-' + ''.join(random.choices(characters, k=4))
            current_time = datetime.now()
    ...
    def my_function():
        try:
            ...
            if re in json_data:
                ...
                msg = f'''<b>♤ Check EBNELNEGM CHK Subscribtion Done ✅
♤ Expires in -> {timer}</b>'''
                bot.reply_to(message, msg, parse_mode="HTML")
            else:
...
- Updated in Subscribers List ✅''')
                ...
                if is_new_vip:
                    combined_message = (
                        f"Hello, Thank you for renewing your EBNELNEGM CHK membership! [🇺🇸]\n\n"
